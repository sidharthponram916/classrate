<template>
  <div class="p-2">
    ...
    <div
      ...
      class="text-left m-auto text-white w-5/6"
    >
    ...
    <div class="text-left m-auto bg-white w-5/6 py-2">
      <form class="m-2 p-2 text-xl">
        ...
        <br />
        <label class="text-left text-2xl"
          >City <span class="text-sm">(Cannot be Changed) </span></label
        >
        <input
          type="text"
        ...
        <br />
        <label class="text-left text-2xl"
          >Logo URL<span class="text-sm"> (Add an image url) </span></label
        >
        <input
          type="url"
        ...
        <button
          @click="editInfo()"
          type="button"
          class="mt-3 text-white rounded p-2 bg-blue-500 mr-4"
        ...
        <button
          @click="revert()"
          type="button"
          class="mt-3 text-white rounded p-2 bg-red-500"
        >
          Revert
        </button>
      </form>
    ...
    async editInfo() {
      try {
        ...
        if (e.response.status === 403)
          return alert(
            "You do not have the correct permissions to edit a page."
          );
      }
    },
    async revert() {
