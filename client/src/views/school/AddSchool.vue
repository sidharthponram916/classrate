<template>
   <div class = 'p-2'>
       ...
       <div class = 'text-left m-auto bg-indigo-900 text-white w-5/6'> 
               <h1 class = 'text-left m-2 p-2 text-4xl'>Add a School 📋</h1>
       ...
       <div class = 'text-left m-auto bg-white w-5/6 py-2'> 
           <form class = 'm-2 p-2 text-xl'> 
               <label class = 'text-left text-2xl'>What is the official name of the school?*</label>
                <input 
                 type = "text"
                 ...
                 >
                 <br>
                <label class = 'text-left text-2xl'>What state is this school located?*</label>
                ...
                <br> 
                <label class = 'text-left text-2xl'>What city is this school located in?*</label>
                <input 
                 type = "text"
                 placeholder = "School Name"
                 :class = "style.input"
                 ...
                 >
                 <br> 
                 <label class = 'text-left text-2xl'>What is the current address of the school?*</label>
                 <input
                 type = "text"
                 ...
                 >
                 <br> 
                 <label class = 'text-left text-2xl'>What is the school's logo?* <span class = 'text-sm'> (Add an image url) </span></label>
                 <input
                 type = "url"
                 ...
                 >
                 <br> 
                 <label class = 'text-left text-2xl'>What is the school's website url? </label>
                 <input
                 type = "url"
                 ...
                 <input 
                  ...
                  >
                  <br>
                 <button @click = "submitInfo()" type = "button" class = 'mt-3 text-white rounded p-2 bg-blue-500' :disabled = "disableInput">Add School</button>
           </form> 
       </div>
   </div>
</template>
...
export default {
     ...
     computed: { 
        disableInput() { 
          if (this.data.name.trim('') ==="" || this.data.city.trim('') == "" || this.data.state.trim('') == "" || this.data.address.trim('') == "") {
              return true; 
          }
          else { 
              return false; 
   ...
   methods: { 
       async submitInfo() { 
           await this.$http.post('/schools/create', { 
                name: this.data.name, 
